...
// Make CRM_Sepacustom_ExtensionUtil available.
require_once __DIR__ . '/../../sepacustom.civix.php';
...
addExtensionToClassLoader('de.systopia.sepacustom');
 ...
 */
function _sepacustom_test_civicrm_container(ContainerBuilder $container): void {
}
